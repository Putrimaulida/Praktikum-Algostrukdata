...
public class ModDataHMSMain {
    public static void main(String[] args) {
        ...
        System.out.println();
        ModDataMHS rerata = new ModDataMHS();
        double r = rerata.rata(dmArray[0].IPK, dmArray[1].IPK, dmArray[2].IPK);
        System.out.println("IPK rata-rata seluruh mahasiswa: " + r);
    }
}
